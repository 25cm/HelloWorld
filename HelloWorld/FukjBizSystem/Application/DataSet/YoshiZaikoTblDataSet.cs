...
namespace FukjBizSystem.Application.DataSet.YoshiZaikoTblDataSetTableAdapters
{
    ...
    partial class YoshiZaikoTblTableAdapter
    {
        ...
        internal void DeleteByShishoCdAndYoshiCd(List<string> listKey)
        {
            ...
            foreach (string key in listKey)
            {
                ...
                sqlCommand.Parameters.Add("@yoshiZaikoShishoCd" + idx, SqlDbType.Char).Value = shishoCd;
                sqlCommand.Parameters.Add("@yoshiZaikoYoshiCd" + idx, SqlDbType.Char).Value = yoshiCd;
    ...
    public partial class YoshiZaikoTblKensakuTableAdapter {
        ...
        private SqlCommand CreateSqlCommand(string shishoCd, string yoshiCdFrom, string yoshiCdTo, string yoshiNm)
        {
            ...
            //{
            //    sqlContent.Append(" AND yzt.YoshiZaikoYoshiCd BETWEEN @yoshiCdFrom AND @yoshiCdTo ");
            //    commandParams.Add("@yoshiCdFrom", SqlDbType.Char).Value = yoshiCdFrom;
            //    commandParams.Add("@yoshiCdTo", SqlDbType.Char).Value = yoshiCdTo;
            //}
