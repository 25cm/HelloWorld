...
namespace FukjBizSystem.Application.DataSet.SuishitsuShikenKoumokuMstDataSetTableAdapters
{
    ...
    public partial class SuishitsuShikenKoumokuMstKensakuTableAdapter
    {
            ...
            )
        {
            ...
            // 水質試験項目コードFROM ~ TO
            sqlContent.Append(" and sskm.SuishitsuShikenKoumokuCd " + DataAccess.DataAccessUtility.SetBetweenCommand(suishitsuShikenKoumokuCdFrom, suishitsuShikenKoumokuCdTo, 3));
