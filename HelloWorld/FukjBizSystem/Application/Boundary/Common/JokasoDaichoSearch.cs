...
namespace FukjBizSystem.Application.Boundary.Common
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    public partial class JokasoDaichoSearchForm : Form
    {
        #region プロパティ(public)
        ...
        /// Selected dgv row
        /// </summary>
        public DataGridViewRow _selectedRow = null;
        ...
        private void jokasoListDataGridView_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                this._selectedRow = jokasoListDataGridView.Rows[jokasoListDataGridView.CurrentRow.Index];
        ...
        private JokasoDaichoMstSearchCond SetSearchCond()
        {
            ...
            // 登録年月
            searchCond.JokasoTorokuNendo = torokuYMTextBox.Text;
