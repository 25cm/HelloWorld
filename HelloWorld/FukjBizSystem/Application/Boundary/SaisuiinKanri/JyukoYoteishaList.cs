...
namespace FukjBizSystem.Application.Boundary.SaisuiinKanri
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    public partial class JyukoYoteishaListForm : Form
    {
        ...
        private void gyosyaNmFromSearchButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    syozokuGyosyaCdFromTextBox.Text = frm._selectedRow.Cells["GyoshaCdCol"].Value.ToString();

                    gyoshaNmFromTextBox.Text = frm._selectedRow.Cells["GyoshaNmCol"].Value.ToString();
                }
            }
            catch (Exception ex)
            {
        ...
        private void gyosyaNmToSearchButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (frm.DialogResult == System.Windows.Forms.DialogResult.OK)
                {
                    syozokuGyosyaCdToTextBox.Text = frm._selectedRow.Cells["GyoshaCdCol"].Value.ToString();

                    gyoshaNmToTextBox.Text = frm._selectedRow.Cells["GyoshaNmCol"].Value.ToString();
                }
            }
            catch (Exception ex)
            {
