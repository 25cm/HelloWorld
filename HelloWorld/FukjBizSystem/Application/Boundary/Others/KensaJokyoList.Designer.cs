namespace FukjBizSystem.Application.Boundary.Others
{
    partial class KensaJokyoListForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.JokasoCdCol.HeaderText = "浄化槽ｺｰﾄﾞ";
            ...
            this.ShisetsuNmCol.MinimumWidth = 200;
            this.ShisetsuNmCol.Name = "ShisetsuNmCol";
            this.ShisetsuNmCol.ReadOnly = true;
            this.ShisetsuNmCol.Width = 200;
            // 
            // KensaIraiCdCol
            // 
            this.KensaIraiCdCol.DataPropertyName = "HokenjoNm";
            this.KensaIraiCdCol.HeaderText = "検査依頼ｺｰﾄﾞ";
            ...
            this.label12.Text = "※計量証明では検索条件として使用しない";
            // 
            // label9
            // 
