...
namespace FukjBizSystem.Application.Boundary.Master
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    public partial class KatashikiMstShosaiForm : Form
    {
        #region 定義(public)
        ...
        private void katashikiBurowaListDataGridView_DefaultValuesNeeded(object sender, DataGridViewRowEventArgs e)
        {
            ...
            try
            {
                ...
                if (_dispMode == DispMode.Edit)
                {
                    ...
                    e.Row.Cells["InsertDtCol"].Value = DateTime.Now;
                    e.Row.Cells["InsertUserCol"].Value = loginUser;
                    e.Row.Cells["InsertTarmCol"].Value = terminal;
                    e.Row.Cells["UpdateDtCol"].Value = DateTime.Now;
        ...
        private void SetControlModeView()
        {
            switch (_dispMode)
            {
                case DispMode.Add:
                    ...
                    // 選択追加ボタン 30
                    selectInsertButton.Enabled = true;

                    // 選択削除ボタン 31
                    selectDeleteButton.Enabled = true;
                ...
                case DispMode.Detail:
                    ...
                    // 選択追加ボタン 30
                    selectInsertButton.Enabled = false;

                    // 選択削除ボタン 31
                    selectDeleteButton.Enabled = false;
