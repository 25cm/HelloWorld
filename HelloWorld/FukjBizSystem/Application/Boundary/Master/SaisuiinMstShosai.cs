...
namespace FukjBizSystem.Application.Boundary.Master
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    public partial class SaisuiinMstShosaiForm : Form
    {
        #region 定義(public)
        ...
        private bool DataCheck()
        {
            ...
            {
                errMsg.Append("必須項目：かな名が入力されていません。\r\n");
            }
            else if (saisuiinKanaTextBox.Text.Length > 40)
            {
                errMsg.Append("かな名は40文字以下で入力して下さい。\r\n");
            }
        ...
        private bool InputCheck()
        {
            ...
            {
                MessageForm.Show2(MessageForm.DispModeType.Error, "かな名は40文字以下で入力して下さい。");
                return false;
            }
        ...
        private SaisuiinMstDataSet.SaisuiinMstDataTable CreateSaisuiinMstInsert()
        {
            ...
            newRow.SaisuiinCd = Common.Common.GetKeyRenban("SaisuiinMst","","","").PadLeft(5,'0');
            // UPD 20140724 END ZynasSou
