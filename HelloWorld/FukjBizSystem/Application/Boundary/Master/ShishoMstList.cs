...
namespace FukjBizSystem.Application.Boundary.Master
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    public partial class ShishoMstListForm : Form
    {
        ...
        private void shosaiButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ShishoMstShosaiForm frm = new ShishoMstShosaiForm(sishoMstListDataGridView.SelectedRows[0].Cells["SishoCdCol"].Value.ToString());
                Program.mForm.ShowForm(frm);
            }
            catch (Exception ex)
            {
