...
namespace FukjBizSystem.Application.ApplicationLogic.KinoHoshoKanri.HoshoShinseiKokan
{
    ...
    interface IExChangeBtnClickALInput : IBseALInput
    {
        ...
        /// ShishoArr
        /// </summary>
        Dictionary<string, string> ShishoArr { get; set; }
    ...
    class ExChangeBtnClickALInput : IExChangeBtnClickALInput
    {
        ...
        /// ShishoArr
        /// </summary>
        public Dictionary<string, string> ShishoArr { get; set; }
    ...
    class ExChangeBtnClickApplicationLogic : BaseApplicationLogic<IExChangeBtnClickALInput, IExChangeBtnClickALOutput>
    {
        ...
        public override IExChangeBtnClickALOutput Execute(IExChangeBtnClickALInput input)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < input.HoshoTorokuInfoDataGridView.RowCount - 1; i++)
                {
                    ...
                    {
                        DeleteOldHoshoToroku(_hoshoTorokuTblDTUpdate);
                    }
                    ...
                    if (_hoshoTorokuTblDTUpdate.Count != 0)
                    {
                        UpdateNewHoshoToroku(_hoshoTorokuTblDTUpdate, row);
                    }
                ...
                foreach (var item in input.ShishoArr)
                {
                    ...
                    _yoshiZaikoTblDTUpdate[0].YoshiZaikoSuryo = _yoshiZaikoTblDTUpdate[0].YoshiZaikoSuryo - Int32.Parse(item.Value);
        ...
        /// </history>
        ///////////////////////////////////////////////////////////////
        private void DeleteOldHoshoToroku(HoshoTorokuTblDataSet.HoshoTorokuTblDataTable hoshoTorokuTblDT)
        {
        ...
        /// </history>
        ///////////////////////////////////////////////////////////////
        private void UpdateNewHoshoToroku(HoshoTorokuTblDataSet.HoshoTorokuTblDataTable hoshoTorokuTblDT, DataGridViewRow row)
        {
            IUpdateHoshoTorokuTblBLInput blInput = new UpdateHoshoTorokuTblBLInput();
        ...
        private void InsertKokanHosho(DataGridViewRow row)
        {
            ...
            string hoshoTorokuNo = row.Cells["NewHoshoTorokuNoCol"].Value.ToString();

            newRow.KokanHoshoTorokuKensakikan = hoshoTorokuNo.Substring(0, 4);
            newRow.KokanHoshoTorokuNendo = Boundary.Common.Common.ConvertToHoshouNendoSeireki(hoshoTorokuNo.Substring(4, 2));
            newRow.KokanHoshoTorokuRenban = hoshoTorokuNo.Substring(6);
            newRow.KokanHoshoRenban = "0";
            newRow.KokanHoshoNo1 = hoshoTorokuNo.Substring(0, 4);
            newRow.KokanHoshoNo2 = Boundary.Common.Common.ConvertToHoshouNendoSeireki(hoshoTorokuNo.Substring(4, 2));
            newRow.KokanHoshoNo3 = hoshoTorokuNo.Substring(6);
