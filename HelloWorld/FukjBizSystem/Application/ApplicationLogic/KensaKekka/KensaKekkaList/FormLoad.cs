...
namespace FukjBizSystem.Application.ApplicationLogic.KensaKekka.KensaKekkaList
{
    ...
    class FormLoadApplicationLogic : BaseApplicationLogic<IFormLoadALInput, IFormLoadALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "KensaKekkaList：FormLoad";
        ...
        public override IFormLoadALOutput Execute(IFormLoadALInput input)
        {
            ...
            try
            {
                IGetHokenjoMstInfoBLInput getHokenjoBLInput = new GetHokenjoMstInfoBLInput();
                output.HokenjoMstDataTable = new GetHokenjoMstInfoBusinessLogic().Execute(getHokenjoBLInput).HokenjoMstDT;

                IGetKensaIraiTblBySearchCondBLInput getKensaIraiTblBLInput = new GetKensaIraiTblBySearchCondBLInput();
                getKensaIraiTblBLInput.KensaDtFrom = input.KensaDtFrom;
                getKensaIraiTblBLInput.KensaDtTo = input.KensaDtTo;
                output.KensaIraiTblKensakuDataTable = new GetKensaIraiTblBySearchCondBusinessLogic().Execute(getKensaIraiTblBLInput).KensaIraiTblKensakuDataTable;
