...
namespace Zynas.Framework.Core.Base.Boundary
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    public partial class BaseTabletForm2 : Form
    {
        #region 定義
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        protected BaseTabletForm2(FormEnd formEnd)
        {
            // フォーム終了時イベントを設定
        ...
        #region BaseTabletForm2_Load
        ////////////////////////////////////////////////////////////////////////////
        //  イベント名 ： BaseTabletForm2_Load
        /// <summary>
        /// 初期ロードの処理を行います
        /// </summary>
        /// <remarks>
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        private void BaseTabletForm2_Load(object sender, EventArgs e)
        {

        }
        #endregion

        #region BaseTabletForm2_Shown
        ////////////////////////////////////////////////////////////////////////////
        //  イベント名 ： BaseTabletForm2_Shown
        /// <summary>
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        private void BaseTabletForm2_Shown(object sender, EventArgs e)
        {
            // モーダル制御フラグがＯＮの場合
            if (ModalFlg)
            {
        ...
        #region BaseTabletForm2_FormClosing
        ////////////////////////////////////////////////////////////////////////////
        //  イベント名 ： BaseTabletForm2_FormClosing
        /// <summary>
        /// フォームが閉じられる際の処理を行います
        /// </summary>
        /// <remarks>
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        private void BaseTabletForm2_FormClosing(object sender, FormClosingEventArgs e)
        {
            Console.WriteLine(string.Format("BaseTabletForm2_FormClosing {0}", this.Text));
            ...
            {
                Console.WriteLine(string.Format("BaseTabletForm2_FormClosing {0}", ex.Message));
            }

        }
        #endregion

        #region BaseTabletForm2_FormClosed
        ////////////////////////////////////////////////////////////////////////////
        //  イベント名 ： BaseTabletForm2_FormClosed
        /// <summary>
        /// フォームが閉じられた際の処理を行います
        /// </summary>
        /// <remarks>
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        private void BaseTabletForm2_FormClosed(object sender, FormClosedEventArgs e)
        {
            Console.WriteLine(string.Format("BaseTabletForm2_FormClosed {0}", this.Text));
