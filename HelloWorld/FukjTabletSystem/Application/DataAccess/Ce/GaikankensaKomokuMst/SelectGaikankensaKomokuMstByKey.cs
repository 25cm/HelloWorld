...
namespace FukjTabletSystem.Application.DataAccess.Ce.GaikankensaKomokuMst
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    class SelectGaikankensaKomokuMstByKeyDataAccess : BaseDataAccessCe<ISelectGaikankensaKomokuMstByKeyDAInput, ISelectGaikankensaKomokuMstByKeyDAOutput>
    {
        ...
        public override ISelectGaikankensaKomokuMstByKeyDAOutput Execute(ISelectGaikankensaKomokuMstByKeyDAInput input)
        {
            ...
            try
            {
                ...
                output.GaikankensaKomokuMst = tableAdapter.GetDataByKey(input.GaikankensaKomokuCd);
