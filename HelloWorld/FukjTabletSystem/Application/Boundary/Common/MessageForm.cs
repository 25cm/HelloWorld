...
namespace FukjTabletSystem.Application.Boundary.Common
{
    ...
    public partial class MessageForm : Form
    {
        ...
        public MessageForm(string message, string title, int type, Color? bgColor, Color? fColor)
        {
            InitializeComponent();
            ...
            if (bgColor.HasValue)
            {
                ...
                this.mainPanel.BackColor = bgColor.Value;
            }

            if (fColor.HasValue)
            {
                this.ForeColor = fColor.Value;
                this.mainPanel.ForeColor = fColor.Value;
            }
