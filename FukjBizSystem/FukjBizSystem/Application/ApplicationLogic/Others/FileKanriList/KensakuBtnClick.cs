...
namespace FukjBizSystem.Application.ApplicationLogic.Others.FileKanriList
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALInput : IBseALInput, IGetFileKanriListBySearchCondBLInput
    {
    ...
    class KensakuBtnClickALInput : IKensakuBtnClickALInput
    {
        ...
        public string DataString
        {
            get
            {
                return string.Format("ファイル名[{0}], 登録日検索使用フラグ[{1}], 登録日（開始）[{2}], 登録日（終了）[{3}]",
                    new string[] {
                        FileName, 
                        TorokuDtUse.ToString(),
                        TorokuDtFrom.ToString("yyyyMMdd"),
                        TorokuDtTo.ToString("yyyyMMdd")
                    });
            }
        }
    }
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALOutput : IGetFileKanriListBySearchCondBLOutput
    {
    ...
    class KensakuBtnClickApplicationLogic : BaseApplicationLogic<IKensakuBtnClickALInput, IKensakuBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "FileKanriList：KensakuBtnClickApplicationLogic";
        ...
        public override IKensakuBtnClickALOutput Execute(IKensakuBtnClickALInput input)
        {
            ...
            try
            {
                output.FileKanriTblKensakuDT = new GetFileKanriListBySearchCondBusinessLogic().Execute(input).FileKanriTblKensakuDT;
            }
            catch
            {
                throw;
