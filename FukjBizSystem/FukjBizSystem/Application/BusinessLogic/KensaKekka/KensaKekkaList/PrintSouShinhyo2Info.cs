...
namespace FukjBizSystem.Application.BusinessLogic.KensaKekka.KensaKekkaList
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    class PrintSouShinhyo2InfoBLInput : IPrintSouShinhyo2InfoBLInput
    {
        /// <summary>
        /// 保存ファイルモード
        /// </summary>
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    class PrintSouShinhyo2InfoBLOutput : IPrintSouShinhyo2InfoBLOutput
    {
        /// <summary>
        /// 保存パス
        /// </summary>
    ...
    class PrintSouShinhyo2InfoBusinessLogic : BaseExcelPrintBusinessLogic<IPrintSouShinhyo2InfoBLInput, IPrintSouShinhyo2InfoBLOutput>
    {
        ...
        protected override IPrintSouShinhyo2InfoBLOutput SetBook(IPrintSouShinhyo2InfoBLInput input, Microsoft.Office.Interop.Excel.Workbook book)
        {
            ...
            try
            {
                ...
                //検査依頼法定区分 (2)
                CellOutput(outputSheet, 6, 3, printRow.ConstNm);
                ...
                //検査担当者  (7)
                CellOutput(outputSheet, 11, 30, printRow.KensaIraiKensaTanato);
                ...
                //検査年 検査月 検査日 (14)
                CellOutput(outputSheet, 18, 25, string.Format("平成  {0}年  {1}月  {2}日", 
                ...
                //処理方式区分 (16)
                CellOutput(outputSheet, 20, 25, printRow.KensaIraiShorihoshikiKbn);

                //処理対象人員 (17)
                CellOutput(outputSheet, 21, 25, printRow.KensaIraiShoritaishoJinin + "人槽");
