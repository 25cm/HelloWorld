...
{
    public partial class NyukinListForm : Form
    {
        public NyukinListForm()
        {
            InitializeComponent();
            this.MaeukekinListDataGridView.Rows.Add("2014000001", "1", "筑　豊", "1234", "株式会社○○環境開発工業", "請求", "20140712", "銀行", "680992", "21,000", "11,000", "10,000", "未","");
            this.MaeukekinListDataGridView.Rows.Add("2014000002", "1", "筑　豊", "2345", "株式会社△△環境開発工業", "請求", "20140720", "現金", "", "34,000", "34,000", "0", "済","10,000");
            this.MaeukekinListDataGridView.Rows.Add("2014000003", "1", "筑　豊", "3456", "株式会社財茄子", "前受金", "20140722", "郵便", "", "9,000", "9,000", "0");
            this.MaeukekinListDataGridView.Rows.Add("2014000004", "1", "筑　豊", "4567", "□□株式会社", "用紙販売", "20140723", "現金", "", "5,000", "5,000", "0", "");

            this.NyukinDtFromTextBox.Value = DateTime.ParseExact("2014/07/01", "yyyy/MM/dd", null);
        }
