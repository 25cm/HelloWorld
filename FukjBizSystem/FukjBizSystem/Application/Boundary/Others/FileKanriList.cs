...
namespace FukjBizSystem.Application.Boundary.Others
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    public partial class FileKanriListForm : Form
    {
        ...
        /// </summary>
        private string fileServerDirectory = Common.Common.GetConstValue(Utility.Constants.ConstKbnConstanst.CONST_KBN_004, Utility.Constants.ConstRenbanConstanst.CONST_RENBAN_001);
        ...
        private FileKanriTblDataSet.FileKanriTblDataTable CreateDataInsert(string fileNmBefore)
        {
            ...
            // ファイルNo
            newRow.FileNo = now.Year.ToString() + Common.Common.GetSaibanRenban(now.Year.ToString(), Utility.Constants.SaibanKbnConstant.SAIBAN_KBN_09);
