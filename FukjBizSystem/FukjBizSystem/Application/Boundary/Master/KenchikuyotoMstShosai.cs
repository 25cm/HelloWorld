...
namespace FukjBizSystem.Application.Boundary.Master
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    public partial class KenchikuyotoMstShosaiForm : Form
    {
        #region 定義(public)
        ...
        /// </summary>
        string _kenchikuyotoDaibunruiCd = string.Empty;

        /// <summary>
        /// kenchikuyotoShobunruiCd
        /// </summary>
        string _kenchikuyotoShobunruiCd = string.Empty;

        /// <summary>
        /// kenchikuyotoRenban
        /// </summary>
        string _kenchikuyotoRenban = string.Empty;

        /// <summary>
        /// kenchikuyotoMstDataTable
        /// </summary>
        KenchikuyotoMstDataSet.KenchikuyotoMstDataTable _kenchikuyotoMstDataTable = new KenchikuyotoMstDataSet.KenchikuyotoMstDataTable();

        /// <summary>
        /// kenchikuyotoDaibunruiMstDataTable 
        /// </summary>
        KenchikuyotoDaibunruiMstDataSet.KenchikuyotoDaibunruiMstDataTable _kenchikuyotoDaibunruiMstDataTable = new KenchikuyotoDaibunruiMstDataSet.KenchikuyotoDaibunruiMstDataTable();

        /// <summary>
        /// kenchikuyotoShobunruiMstDataTable
        /// </summary>
        KenchikuyotoShobunruiMstDataSet.KenchikuyotoShobunruiMstDataTable _kenchikuyotoShobunruiMstDataTable = new KenchikuyotoShobunruiMstDataSet.KenchikuyotoShobunruiMstDataTable();
