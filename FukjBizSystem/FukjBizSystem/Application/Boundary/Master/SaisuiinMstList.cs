...
namespace FukjBizSystem.Application.Boundary.Master
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    public partial class SaisuiinMstListForm : Form
    {
        ...
        private void shosaiButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SaisuiinMstShosaiForm frm = new SaisuiinMstShosaiForm(saisuiinMstListDataGridView.SelectedRows[0].Cells["SaisuiinCdCol"].Value.ToString());
                Program.mForm.ShowForm(frm);
            }
            catch (Exception ex)
            {
