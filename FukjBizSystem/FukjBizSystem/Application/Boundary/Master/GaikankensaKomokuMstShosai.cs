...
namespace FukjBizSystem.Application.Boundary.Master
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    public partial class GaikankensaKomokuMstShosaiForm : Form
    {
        #region 定義(public)
        ...
        private void deleteButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                    ...
                    == System.Windows.Forms.DialogResult.Yes)
                {
                    ...
                    if (alOutput.Result)
                    {
                        GaikankensaKomokuMstListForm form = new GaikankensaKomokuMstListForm();
        ...
        private GaikankensaKomokuMstDataSet.GaikankensaKomokuMstDataTable CreateDataInsert()
        {
            ...
            insertRow.GaikankensaKomokuCd = Common.Common.GetKeyRenban("GaikankensaKomokuMst", "", "", "").PadLeft(3,'0');
            // UPD 20140724 END ZynasSou
