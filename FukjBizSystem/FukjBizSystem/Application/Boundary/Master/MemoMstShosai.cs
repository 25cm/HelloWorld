...
namespace FukjBizSystem.Application.Boundary.Master
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    public partial class MemoMstShosaiForm : Form
    {
        #region 定義(public)
        ...
        private void deleteButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                    ...
                    == System.Windows.Forms.DialogResult.Yes)
                {
                    ...
                    if (alOutput.Result)
                    {
                        MemoMstListForm form = new MemoMstListForm();
        ...
        private MemoMstDataSet.MemoMstDataTable CreateDataInsert()
        {
            ...
            // メモコード
            insertRow.MemoCd = Common.Common.GetKeyRenban("MemoMst", memoDaibunruiListBox.SelectedValue.ToString(), "", "").PadLeft(3, '0');
