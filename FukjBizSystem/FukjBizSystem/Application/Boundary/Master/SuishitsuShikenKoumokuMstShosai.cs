...
namespace FukjBizSystem.Application.Boundary.Master
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    public partial class SuishitsuShikenKoumokuMstShosaiForm : Form
    {
        #region 定義(public)
        ...
        private SuishitsuShikenKoumokuMstDataSet.SuishitsuShikenKoumokuMstDataTable CreateSuishitsuShikenKoumokuMstUpdate(SuishitsuShikenKoumokuMstDataSet.SuishitsuShikenKoumokuMstDataTable suishitsuShikenKoumokuMstDT)
        {
            ...
            //定量表示用1(18)
            suishitsuShikenKoumokuMstDT[0].TeiryoHyojiyo1 = teiryoHyojiyo1TextBox.Text.PadLeft(5, ' ');

            //定量表示用2(19)
            suishitsuShikenKoumokuMstDT[0].TeiryoHyojiyo2 = teiryoHyojiyo2TextBox.Text.PadLeft(5, ' ');
