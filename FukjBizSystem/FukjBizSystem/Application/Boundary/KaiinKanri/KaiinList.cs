...
namespace FukjBizSystem.Application.Boundary.KaiinKanri
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    public partial class KaiinListForm : Form
    {
        ...
        private void MakeSearchCond(IKensakuBtnClickALInput alInput)
        {
            ...
            // 製造
            alInput.Seizo = seizoGyoShaKbnCheckBox.Checked;

            // 工事
            alInput.Koji = kojiGyoshaKbnCheckBox.Checked;

            // 保守
            alInput.Hosyu = hoshuGyoshaKbnCheckBox.Checked;

            // 清掃
            alInput.Seiso = seisoGyoshaKbnCheckBox.Checked;

            // 未加入
            alInput.Mikanyu = sonotaGyoshaKbnCheckBox.Checked;
        }
        #endregion
        ...
        private bool CheckCondition()
        {
            ...
            // 会員区分
            if (!seizoGyoShaKbnCheckBox.Checked
                && !kojiGyoshaKbnCheckBox.Checked
                && !hoshuGyoshaKbnCheckBox.Checked
                && !seisoGyoshaKbnCheckBox.Checked
                && !sonotaGyoshaKbnCheckBox.Checked)
            {
        ...
        private void SetDefaultValues()
        {
            ...
            // 製造
            seizoGyoShaKbnCheckBox.Checked = true;

            // 工事
            kojiGyoshaKbnCheckBox.Checked = true;

            // 保守
            hoshuGyoshaKbnCheckBox.Checked = true;

            // 清掃
            seisoGyoshaKbnCheckBox.Checked = true;
