...
namespace FukjBizSystem.Application.Boundary.SaisuiinKanri
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    public partial class SaisuiinShomeishoHakkoForm : Form
    {
        ...
        private void syozokuGyoshaFromSearchButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // 所属業者名（開始）(8)
                syozokuGyoshaNmFromTextBox.Text = (form._selectedRow.Cells["GyoshaNmCol"].Value != null) 
                    ? form._selectedRow.Cells["GyoshaNmCol"].Value.ToString() : string.Empty;

                // 所属業者コード（開始）(hidden)
                syozokuGyosyaCdFromTextBox.Text = (form._selectedRow.Cells["GyoshaCdCol"].Value != null) 
