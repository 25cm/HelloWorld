...
namespace FukjBizSystem.Application.Boundary.SaisuiinKanri
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    public partial class JyukoshaInputForm : Form
    {
        ...
        private void jyukoshaListDataGridView_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                //if (!_isLoad || jyukoshaListDataGridView.Rows[e.RowIndex].Cells["SaisuiinCdCol"].Value == null) return;
                if (!_isLoad) return;

                string saisuiinCd = (jyukoshaListDataGridView.Rows[e.RowIndex].Cells["SaisuiinCdCol"].Value == null) ? "" : jyukoshaListDataGridView.Rows[e.RowIndex].Cells["SaisuiinCdCol"].Value.ToString().Trim();
                ...
                {
                    jyukoshaListDataGridView.Rows[e.RowIndex].Cells["SaisuiinCdCol"].Value = string.Empty;
                }

                jyukoshaListDataGridView.Rows[e.RowIndex].Cells["SaisuiinNmCol"].Value = saisuiinNm;
                jyukoshaListDataGridView.Rows[e.RowIndex].Cells["SyozokuGyosyaNmCol"].Value = gyoshaNm;
                jyukoshaListDataGridView.Rows[e.RowIndex].Cells["UpdateDtCol"].Value = updateDt;
        ...
        private bool IsValidInput()
        {
            ...
            {
                string saisuiinCd = jyukoshaListDataGridView.Rows[i].Cells["SaisuiinCdCol"].Value.ToString().Trim();
