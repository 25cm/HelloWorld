...
namespace FukjBizSystem.Application.Boundary.SaisuiinKanri
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    public partial class SaisuiinInfoShosaiForm : Form
    {
        #region 定義(public)
        ...
        private void shozokuGyosyaSearchButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // 所属業者コード(4)
                syozokuGyosyaCdTextBox.Text = (frm._selectedRow.Cells["GyoshaCdCol"].Value != null) ? frm._selectedRow.Cells["GyoshaCdCol"].Value.ToString() : string.Empty;

                // 所属業者名(2)
                syozokuGyosyaNmTextBox.Text = (frm._selectedRow.Cells["GyoshaNmCol"].Value != null) ? frm._selectedRow.Cells["GyoshaNmCol"].Value.ToString() : string.Empty;
            }
            catch (Exception ex)
            {
                TraceLog.ErrorWrite(MethodInfo.GetCurrentMethod(), ex.ToString());
        ...
        private void addressSearchButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // 採水員郵便番号(7)
                saisuiinZipCdTextBox.Text = (form._selectedRow.Cells["ZipCdCol"].Value != null) ? form._selectedRow.Cells["ZipCdCol"].Value.ToString() : string.Empty;
        ...
        private SaisuiinMstDataSet.SaisuiinMstDataTable CreateSaisuiinMstInsert()
        {
            ...
            // 採水員コード(1)
            newRow.SaisuiinCd = Common.Common.GetKeyRenban("SaisuiinMst", string.Empty, string.Empty, string.Empty).PadLeft(5, '0');
