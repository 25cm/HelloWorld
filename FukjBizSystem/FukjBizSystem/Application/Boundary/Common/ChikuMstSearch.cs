...
namespace FukjBizSystem.Application.Boundary.Common
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    public partial class ChikuMstSearchForm : Form
    {
        #region プロパティ(public)
        ...
        private void ChikuMstSearchForm_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.chikuMstKensakuTableAdapter.Fill(this.chikuMstDataSet.ChikuMstKensaku);
        ...
        private void torokuButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this._selectedRow = chikuListDataGridView.Rows[chikuListDataGridView.CurrentRow.Index];
