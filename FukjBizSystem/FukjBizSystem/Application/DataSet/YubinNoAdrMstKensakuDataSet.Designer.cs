    ...
    public partial class YubinNoAdrMstKensakuDataSet : global::System.Data.DataSet {
        ...
        public partial class TodofukenInfoDataTable : global::System.Data.TypedTableBase<TodofukenInfoRow> {
            ...
            private void InitClass() {
                ...
                this.columnTodofukenNm.AllowDBNull = false;
                this.columnTodofukenNm.MaxLength = 50;
                this.columnKenCd.ReadOnly = true;
            ...
            public string KenCd {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("テーブル \'TodofukenInfo\' にある列 \'KenCd\' の値は DBNull です。", e);
                    }
                }
                set {
...
SELECT ZipCd, OldZipCd, TodofukenKana, ShikuchosonKana, ChoikiKana, TodofukenNm, ShikuchosonNm, ChoikiNm, ChihoKokyoDantaiCd, InsertDt, InsertUser, InsertTarm, UpdateDt, UpdateUser, UpdateTarm FROM YubinNoAdrMst WHERE (ZipCd = @ZipCd)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ZipCd, OldZipCd, TodofukenKana, ShikuchosonKana, ChoikiKana, TodofukenNm, " +
                "ShikuchosonNm, ChoikiNm, ChihoKokyoDantaiCd, InsertDt, InsertUser, InsertTarm, U" +
                "pdateDt, UpdateUser, UpdateTarm FROM dbo.YubinNoAdrMst";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT            ZipCd, OldZipCd, TodofukenKana, ShikuchosonKana, ChoikiKana, TodofukenNm, ShikuchosonNm, ChoikiNm, ChihoKokyoDantaiCd, InsertDt, InsertUser, InsertTarm, UpdateDt, 
...
WHERE             (ZipCd = @ZipCd)";
            ...
            this._commandCollection[2].CommandText = @"SELECT            ZipCd, OldZipCd, TodofukenKana, ShikuchosonKana, ChoikiKana, TodofukenNm, ShikuchosonNm, ChoikiNm, ChihoKokyoDantaiCd, InsertDt, InsertUser, InsertTarm, UpdateDt, 
                        UpdateUser, UpdateTarm
FROM              YubinNoAdrMst
WHERE             (TodofukenNm = @TodofukenNm) AND (ShikuchosonNm + ChoikiNm LIKE @Adr)";
    ...
    public partial class TodofukenInfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT DISTINCT TodofukenNm, LEFT(ChihoKokyoDantaiCd, 2) AS KenCd\r\nFROM          " +
                "    YubinNoAdrMst\r\nORDER BY       KenCd";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
