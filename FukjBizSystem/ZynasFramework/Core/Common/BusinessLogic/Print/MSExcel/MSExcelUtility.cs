...
namespace Zynas.Framework.Core.Common.BusinessLogic.Print.MSExcel
{
    ...
    {
        // TODO IDX_ORIGINをパラメータにより、可変とする(0がデフォルトだが、1も考慮)
        /// <summary>
        /// 
        /// </summary>
        ...
        // TODO 必要なメソッド類を適宜実装する（行追加、削除、コピー、ブロックコピー等）
        ...
        // TODO プリンタ名を指定できるバージョンを用意する
        // TODO 帳票毎に異なる用紙(のプリンタ)を指定できる仕組みを用意する
        // TODO Excel側は、ローカルプリンタ設定名を認識する（Canon LBP3300など）
